...
export function FloatingWhatsAppButton() {
  ...
  return (
    <a
      ...
      className="floating-action-safe fixed z-30 inline-flex h-14 w-14 items-center justify-center rounded-full bg-brand-whatsapp text-white shadow-brand-xl transition duration-200 ease-out-expo hover:-translate-y-0.5 hover:brightness-95 focus-visible:outline-brand-primary active:translate-y-0 active:scale-[0.97] sm:h-16 sm:w-16"
      href={whatsappUrl}
