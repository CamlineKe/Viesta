...
| 4     | Cart hierarchy and state consistency            | Implemented; awaiting review | Confirm filled and empty states, item/summary hierarchy, destructive-action clarity, long-copy wrapping, sticky summary, and protected price/quantity surfaces                |
