...
| 3     | Shop discovery refinement                       | Implemented; awaiting review | Confirm shared field treatment, category semantics, result feedback, sticky filters, empty state, product-card density, and representative grid breakpoints                   |
